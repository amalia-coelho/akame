...
if($_POST['nm_produto'] == "" or $_POST['nr_valor'] == "" or $_POST['ds_produto'] == "" or $_POST['nr_estoque'] == ""){
    ...
    if ($script_produtos->rowCount() > 0) {
        ...
        if($ext_1 == '.jpg' || $ext_1 == 'jpeg' || $ext_1 == '.png' || $ext_2 == '.jpg' || $ext_2 == 'jpeg' || $ext_2 == '.png'){
            try{
                ...
                $stmt = $conn->prepare('INSERT INTO tb_products(nm_produto, vl_produto, ds_produto, img_1, img_2, nr_estoque) VALUES(:nm_produto, :nr_valor, :ds_produto, :img_1, :img_2, :nr_estoque)');
